 ...
 * `\Aop\KindConstantInterface::KIND_BEFORE_PROPERTY` (write and read)
 * handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_BEFORE_PROPERTY
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class BeforePropertyJoinPoint extends BeforeJoinPoint implements
    ...
    Support\PropertyValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_BEFORE_PROPERTY;
    }
}
