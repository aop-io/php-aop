 ...
 * `\Aop\KindConstantInterface::KIND_AFTER_PROPERTY` (write and read) handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AFTER_PROPERTY
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AfterPropertyJoinPoint extends AfterJoinPoint implements
    ...
    Support\PropertyValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AFTER_PROPERTY;
    }
}
