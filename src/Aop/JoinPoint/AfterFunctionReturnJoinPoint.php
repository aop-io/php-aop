 ...
 * `\Aop\KindConstantInterface::KIND_AFTER_FUNCTION_RETURN` handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AFTER_FUNCTION_RETURN
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AfterFunctionReturnJoinPoint extends AfterJoinPoint implements
    ...
    Support\ReturnValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AFTER_FUNCTION_RETURN;
    }
}
