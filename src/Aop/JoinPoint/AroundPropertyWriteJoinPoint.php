 ...
 * `\Aop\KindConstantInterface::KIND_AROUND_PROPERTY_WRITE` handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AROUND_PROPERTY_WRITE
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AroundPropertyWriteJoinPoint extends AroundJoinPoint implements
    ...
    Support\PropertyValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AROUND_PROPERTY_WRITE;
    }
}
