 ...
 * `\Aop\KindConstantInterface::KIND_AFTER_PROPERTY_WRITE` handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AFTER_PROPERTY_WRITE
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AfterPropertyWriteJoinPoint extends AfterJoinPoint implements
    ...
    Support\PropertyValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AFTER_PROPERTY_WRITE;
    }
}
