 ...
 * `\Aop\KindConstantInterface::KIND_AFTER_METHOD` handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AFTER_METHOD
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AfterMethodJoinPoint extends AfterJoinPoint implements
    ...
    Support\ReturnValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AFTER_METHOD;
    }
}
