 ...
 * `\Aop\KindConstantInterface::KIND_AFTER_METHOD_THROW` handled by the interceptor.
 *
 * @see \Aop\KindConstantInterface::KIND_AFTER_METHOD_THROW
 *
 * @author Nicolas Tallefourtane <dev@nicolab.net>
 */
class AfterMethodThrowJoinPoint extends AfterJoinPoint implements
    ...
    Support\ReturnValueSetterSupportInterface
{
    ...
    {
        return \Aop\KindConstantInterface::KIND_AFTER_METHOD_THROW;
    }
}
